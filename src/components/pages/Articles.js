  ...
  render() {
    return (
      <main className="articles">
        <h2>Articles on web development, engineering and design</h2>
        ...
        <a href="articles/wordpress-one-page.html">
          <article className="article-card">
        ...
        <a href="articles/passive-income.html">
          <article className="article-card">
        ...
        <a href="articles/modern-web-dev.html">
          <article className="article-card">
        ...
        <a href="articles/bem-methodology.html">
          <article className="article-card">
        ...
        <a href="articles/css-layout-techniques.html">
          <article className="article-card">
